    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (args[0].equals(GET_CATEGORIES_LIST)) {
                ...
                if (args.length > 1) {
                    x = Zenodotus.getCategory(args[1]);
                    System.out.println("[MAIN] search completed.");
                    if (args.length > 2) {
                ...
                JSONObject x = new JSONObject();
                if (args.length > 1) {
                    x = Zenodotus.getRelation(args[1]);
                    System.out.println("[MAIN] search completed.");
                    if (args.length > 2) {
                        if (args[2].equals(SAVE)) {
                            System.out.println("[MAIN] Saving...");
                ...
                JSONObject x = new JSONObject();
                if (args.length > 2) {
                    x = Zenodotus.getCategoryInstance(args[1], args[2]);
                    System.out.println("[MAIN] search completed.");
                    if (args.length > 3) {
                ...
                if (args.length > 1) {
                    ...
                    x = Zenodotus.searchCategory(args[1]);
                    System.out.println("[MAIN] search completed.");
                    if (args.length > 2) {
                        if (args[2].equals(SAVE)) {
                            System.out.println("[MAIN] Saving...");
                ...
                if (args.length > 1) {
                    System.out.println("[MAIN] It may take a while.");
                    x = Zenodotus.searchRelation(args[1]);
                    System.out.println("[MAIN] search completed.");
                    if (args.length > 2) {
                        if (args[2].equals(SAVE)) {
                            System.out.println("[MAIN] Saving...");
